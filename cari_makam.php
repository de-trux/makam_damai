...
<body>
  ...
  <div class="container high-padding">
    <div class="row mt-4">
      <div class="col-md-8 mx-auto white rounded p-4">
        <h5 class="text-center font-weight-bold">Halaman Pencarian Makam</h5>
        <hr class="my-1">
        <h5 class="text-center text-secondary">Cari Makam</h5>
        <form action="cari_makam_details.php" method="post" class="p-3">
  ...
  <script src="js/makam_search_script.js"></script>
</body>
