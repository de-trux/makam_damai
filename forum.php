        ...
        <div class="inner-main">
            ...
            <div class="inner-main-header">
                ...
                <span class="input-icon input-icon-sm ml-auto w-auto">
                    <input type="text" class="form-control form-control-sm bg-gray-200 border-gray-200 shadow-none mb-4 mt-4" placeholder="Cari" />
                </span>
            </div>
            <!-- /Inner main header -->
                    ...
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            ...
                            <div class="media-body">
                                <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Forum Makam Cahaya</a></h6>
                                <p class="text-secondary">
                                    tempat untuk berdiskusi untuk perbaikan makam
                                </p>
                ...
                <div class="card mb-2">
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            ...
                            <div class="media-body">
                                <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Forum Makam Guna Darma</a></h6>
                                <p class="text-secondary">
                                tempat untuk berdiskusi untuk perbaikan makam
                                </p>
                ...
                <div class="card mb-2">
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            ...
                            <div class="media-body">
                                <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">Forum Makam Berkah</a></h6>
                                <p class="text-secondary">
                                tempat untuk berdiskusi untuk perbaikan makam 
                                </p>
            ...
            <div class="modal-content">
                <form>
                    <div class="modal-header d-flex align-items-center bg-primary text-white">
                        <h6 class="modal-title mb-0" id="threadModalLabel">Buka Forum Baru</h6>
